...
Thank you for your interest in contributing to **Boxer**! Boxer is a premium, modern DOS emulator for macOS.
...
4. **Verification & Testing**:
   - Verify that the project compiles cleanly without warnings:
     ```bash
     xcodegen generate && xcodebuild -scheme Boxer -destination 'platform=macOS' build
     ```
...
By contributing to Boxer, you agree that your contributions will be licensed under the [GNU General Public License v2.0](LICENSE).
